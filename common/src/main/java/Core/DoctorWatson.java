...
// This represents the NPC Dr. Watson, a specialized MovableCharacter who can
// provide players with hints from a predefined list.
public class DoctorWatson extends MovableCharacter {
  ...
  // This provides a hint to the player. When all hints have been given,
  ...
  public String provideHint() {
    ...
    // I select and remove a random hint from the current cycle.
