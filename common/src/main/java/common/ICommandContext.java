...
// This defines the contract for a command's execution context. It's a crucial abstraction
// layer that allows my `common` commands to interact with the server's game state without
// depending on concrete server classes.
