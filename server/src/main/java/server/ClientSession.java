...
public class ClientSession {
  ...
  public void setGameSessionId(String gameSessionId) {
    logger.debug(
        "Updating gameSessionId for player {}: old='{}', new='{}'",
        this.playerId,
        this.gameSessionId,
        gameSessionId);
  ...
  public void setLocalCases(List<CaseInfoDTO> localCases) {
    ...
    logger.debug("Set {} local cases for player {}", this.localCases.size(), this.playerId);
  }
  ...
  public void setAuthenticatedUser(User authenticatedUser) {
    logger.debug(
        "Setting authenticated user for player {}: {}",
        this.playerId,
