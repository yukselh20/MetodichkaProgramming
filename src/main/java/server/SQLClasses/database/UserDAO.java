...
public class UserDAO {
  ...
  public Optional<User> findUserByUsername(String username) {
    ...
    try (Connection conn = DatabaseManager.getConnection();
      ...
      System.err.println("Database error in findUserByUsername: " + e.getMessage());
      e.printStackTrace();
    }
  ...
  public Optional<String> getPasswordHashForUser(String username) {
    ...
    try (Connection conn = DatabaseManager.getConnection();
      ...
      System.err.println("Database error in getPasswordHashForUser: " + e.getMessage());
      e.printStackTrace();
    }
    return Optional.empty();
  }
  ...
  public Optional<User> addUser(String username, String plainPassword) {
    ...
    // --- DEBUG ---
    System.out.println("[DEBUG] UserDAO: Attempting to get database connection...");

    try (Connection conn = DatabaseManager.getConnection();
        PreparedStatement pstmt = conn.prepareStatement(sql)) {

      // --- DEBUG ---
      System.out.println("[DEBUG] UserDAO: Database connection successful.");
