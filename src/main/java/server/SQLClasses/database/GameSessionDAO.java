...
public class GameSessionDAO {
  ...
  public void saveOrUpdateGameState(int ownerId, String caseTitle, GameStateData data) {
    ...
    try (Connection conn = DatabaseManager.getConnection();
      ...
      System.err.println("Database error during saveOrUpdateGameState for user " + ownerId);
      e.printStackTrace();
    } catch (JsonProcessingException e) {
      System.err.println("Error serializing game state to JSON for user " + ownerId);
      e.printStackTrace();
    }
  }
